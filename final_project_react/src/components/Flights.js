...
const columns = [
  ...
  { id: "origin_county", label: "Origin Country", minWidth: 100 },
  { id: "destination_county", label: "Destination Country", minWidth: 100 },
...
const Flights = () => {
  ...
  const navigateToDeparturesArrivals = () => {
    window.location.replace("http://localhost:5000/flights");
  };
